---
name: tfm-lp
description: "when working on the labelpropagation project"
model: inherit
color: green
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/home/sergio/src/tfm/labelpropagation/.claude/agent-memory/tfm-lp/`. Its contents persist across conversations.
