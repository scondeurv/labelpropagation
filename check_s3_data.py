#!/usr/bin/env python3
"""Check what data exists in S3/MinIO for label propagation"""
import boto3
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Check S3/MinIO data for Label Propagation")
    ...
    parser.add_argument("--prefix", default="graphs/", help="Key prefix to list")
